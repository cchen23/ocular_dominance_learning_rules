...
def recurrent_connections_simulation_averaged(update_function):
    num_neurons = 500
    num_timesteps = 100
    num_inputs = 2
    learning_rate = 0.1
...
def recurrent_connections_simulation(update_function):
    num_neurons = 500
    num_timesteps = 100
    num_inputs = 2
    learning_rate = 0.01
...
if __name__ == "__main__":
    #recurrent_connections_simulation_averaged(utils.basic_hebb_averaged_update)
    recurrent_connections_simulation(utils.basic_hebb_update)